...
public class TestBase {
	...
	protected void fillContactForm(ConactData contact) {
	    ...
	    driver.findElement(By.name("address")).sendKeys(contact.firstaddress);
	    ...
	    new Select(driver.findElement(By.name("bmonth"))).selectByVisibleText(contact.monthname);
	    driver.findElement(By.name("byear")).clear();
	    driver.findElement(By.name("byear")).sendKeys(contact.year);
	    new Select(driver.findElement(By.name("new_group"))).selectByVisibleText(contact.chosengroup);
